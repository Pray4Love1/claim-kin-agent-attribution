...
def format_withdrawable(value: Any) -> str:
    ...
    The value returned from the API is typically a numeric string.  We normalise
    ...
    zeros.  This avoids printing values such as ``"1E+3"`` while preserving the
    original precision where required.
    """
